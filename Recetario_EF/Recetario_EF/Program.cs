...
namespace Recetario_EF
{
    internal class Program
    {
            ...
            do
            {
                ...
                switch (numero)
                {
                    ...
                    case 1://Ver todas las Recetas
                        var recetas = recetaCtrl.Get(null, null, null, null, null);
                    ...
                    case 3://Encontrar Recetas por coincidencia de nombre
                        ...
                        var rece = recetaCtrl.Get(nombreR,null,null,null,null);
                    ...
                    case 4://Encontrar recetas por intervalo de fechas
                        ...
                        var listaRecetas = recetaCtrl.Get(null,desde,hasta,null,null);
                        Console.WriteLine("");
                        foreach (var r in listaRecetas)
                        {
                            var s = string.Format("Titulo: {0}\nIngredientes: \n{1}\n Procedimiento:\n{2}\n Oculto: {3}", r.Titulo, r.Ingredientes, r.Procedimiento, r.Oculto);
                            Console.WriteLine(s);
                            Console.WriteLine("---------------------------");
                        }
                        Console.WriteLine("\n");
                        break;
                    case 5://Encontrar recetas por categoría
                        Console.WriteLine("");
                        Console.WriteLine("Recetas por Categoría");
                        Console.Write("Ingrese el id de la Categoría: ");
                        idCategoria = int.Parse(Console.ReadLine());
                        var recetasCategoria = recetaCtrl.Get(null, null, null,null,null);
                    ...
                    case 6://Encontrar recetas por id de Usuario
                        ...
                        var recetaPorUsuario = recetaCtrl.Get(null,from,null,null,null);
                        foreach ( var r in recetaPorUsuario)
                        {
                            var s = string.Format("Titulo: {0}\nIngredientes: \n{1}\nProcedimiento:\n{2}\nOculto: {3}\nFecha: {4}", r.Titulo, r.Ingredientes, r.Procedimiento, r.Oculto,r.FechaDeCreacion);
                            Console.WriteLine(s);
                            Console.WriteLine("---------------------------");
        ...
        {//Obtener publicaciones que estan visibles
            //Inicializar los repositorios con el mismo contexto
            var dbContext = new RecetarioDbContext();
            ...
            do
            {
                ...
                switch (numero)
                {
                    ...
                    case 1://Ver todas las publicaciones
                        ...
                        var publicaciones = publicacionCtrl.Get(null, null,null);
                        Console.WriteLine("");
                    ...
                    case 2://Encontrar publicaciones por intervalo de fechas
                        ...
                        var publicacioness = publicacionCtrl.Get(from,to,null);
                        Console.WriteLine("");
                    ...
                    case 4://Ver publicaciones de una receta
                        ...
                        idReceta = int.Parse(Console.ReadLine());
                        Console.WriteLine("");
                        var listapublicaciones = publicacionCtrl.Get(null, null, idReceta);
